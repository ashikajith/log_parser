...
module WebPageLog
  # Class to process the collection of the logs to desired output
  class VisitorCollection
    ...
    def total_page_views
      ...
      grouped_hash = group_by_visitor_count.sort_by { |_key, count| -count }.to_h
